...
public class FoodGet {
    ...
    public void foodsGet(Long foodId) throws Exception{
    ...
    public String buildRequest(Long foodId) throws Exception { //Generate parametrized parameters
